...
class HammingDist(WeightedFunction):
    """
    Function for checking if a variable is identical to a given value.
    """


# @cond PRIVATE
def_function_class('HammingDist', lambda i, toCompare: [i],
                   lambda x, toCompare: 0 if x == toCompare else 1,
                   module=__name__)
# @endcond
